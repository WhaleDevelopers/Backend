...
public class CategoryService {
    ...
    //Embedding용 CategoryInfo 객체 조회
    public InterviewQuestion.CategoryInfo getCategoryInfoById(ObjectId categoryId) {
        ...
        return InterviewQuestion.CategoryInfo.builder()
                .id(category.getId())
